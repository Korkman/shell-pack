...
editor.defineMode(
  ...
  [
    ...
    ["left", "select_left"],
    ["right", "select_right"],
    ["pagedown", "select_page_down"],
    ["pageup", "select_page_up"],
    ["home", "select_line_start"],
    ["end", "select_line_end"],
    ["C-Left", "select_word_left"],
    ["C-Right", "select_word_right"],
    ["M-Left", "block_select_left"],
    ["M-Right", "block_select_right"],
    ["M-Up", "block_select_up"],
    ["M-Down", "block_select_down"],
    ["M-j", "block_select_down"],
    ["M-h", "block_select_left"],
    ["M-l", "block_select_right"],
    ["M-k", "block_select_up"],
