...
complete -c onman -l kernel -x -d "Override OS type (e.g. Linux, Darwin, FreeBSD)" -a "Linux Darwin FreeBSD NetBSD OpenBSD"
complete -c onman -l os -x -d "Override OS ID and version/codename (e.g. debian:bookworm, alpine:3.12)" -a "alpine arch centos debian fedora freebsd netbsd openbsd ubuntu"
complete -c onman -l os-id -x -d "Override OS ID from os-release (e.g. debian, arch, alpine:3.12)" -a "alpine arch centos debian fedora freebsd netbsd openbsd ubuntu"
