...
complete -c __sp_pager -l no-syntax -x -d "Disable bat syntax highlighting"
complete -c __sp_pager -s F -l quit-if-one-screen -x -d "Output content without pager when it fits one screen"
